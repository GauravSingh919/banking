            ...
            <div class="col-lg-6 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="withdraw.php?customer_id=<?= $user_id ?>" class="btn btn-primary">Make a Withdrawal</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="deposit.php?customer_id=<?= $user_id ?>" class="btn btn-primary">Make a Deposit</a>
                    </div>
                </div>
            </div>
            <div class="p-4 md-6">
